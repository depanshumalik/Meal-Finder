...
// To fetch meals from api and return it
...
// To show's all meals card in main acording to search input value
...
//To show full meal details in main 
...
// To shows all favourites meals in favourites body
...
//To adds and remove meals to favourites list
function addRemoveToFavList(id) {
    ...
    if (contain) {
        ...
        arr.splice(number, 1);
        alert("Meal is removed from favourites list");
    } else {
        arr.push(id);
        alert("Meal is added to favourites list");
    }
